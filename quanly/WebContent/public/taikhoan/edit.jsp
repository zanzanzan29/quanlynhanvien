        ...
        <div class="content">
            <div class="ttk">
                ...
                <%
		        	...
		        	TaiKhoan itemTK = (TaiKhoan) request.getAttribute("itemTK");
		        	if(itemTK != null){
		        		username = itemTK.getUsername();
		        		fullname = itemTK.getFullname();
		        		position = itemTK.getPosition();
		        	}
		        	if("1".equals(err)){
                ...
                <form action="" class="addtk" role="form" method="post" enctype="multipart/form-data">
                    ...
                    <input type="text" id="username" name="username" placeholder="Nhập tên tài khoản..." value="<%if(username != null){out.print(username);} %>" disabled="disabled"><br><br>
                    <label>Mật Khẩu:</label>
                    <input type="password" id="password" name="password" placeholder="Nhập mật khẩu..." value=""><br><br>
