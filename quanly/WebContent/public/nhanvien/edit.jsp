        ...
        <div class="content">
            <div class="ttk">
                ...
                <%
		        	...
		        	NhanVien itemNV = (NhanVien) request.getAttribute("itemNV");
		        	if(itemNV != null){
		        		gioitinh = itemNV.getGioitinh();
		        		taikhoan = String.valueOf(itemNV.getTaiKhoan().getId());
		        		address = itemNV.getAddress();
		        		chucvu = String.valueOf(itemNV.getLuongCB().getId());
		        	}	
		        	if("1".equals(err)){
                ...
                <form action="" class="addtk" method="post">
                	...
                	<select name="taikhoan" id="taikhoan">
                		...
                		%>
                        <option value="<%=itemTK.getId() %>" <% if(taikhoan != null && Integer.parseInt(taikhoan) == itemTK.getId() ){out.print("selected");} %> disabled="disabled"><%=itemTK.getFullname() %></option>
                        <% } } %>
                    </select>
